...
<div class="row text">
    <div class="col-xs-3">
        <label for="sensorhersteller"><span>sensorhersteller</span></label>
    </div>
    <div class="col-xs-7">
        <input type="text" class="form-control" placeholder="sensorhersteller" name="sensorhersteller" required>

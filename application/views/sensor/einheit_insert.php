...
<div id="search" class="w900">
	<h4>Add Sensor Einheit</h4>
	
<br>
<form action="<?php site_url('sensor/einheit_insert') ?>" method="post">
    <table class="table table-striped">
<tr>
    <td> <h5><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span></h5></td>
    <td><h5>Zeigen Alle Sensor Einheit</h5></td>
    <td>
        ...
        <tr class="active">
            <td>    
                <span><h4>Add neu Sensor Einheit</h4></span>
            </td>
            <td>

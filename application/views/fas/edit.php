...
<input type="hidden" name="eingabe" value="<?php echo $update['fas'][0]['eingabe']; ?>"/>
<input type="hidden" name="aenderung" value="<?php echo date('Y-m-d'); ?>"/>
<input type="hidden" name="fas_id" value="<?php echo $fas_id; ?>"/>
<!-- fas name start -->
<br />
...
<div class="row text">
    ...
    <div class="col-xs-7">
        <input type="text" class="form-control " value="<?php echo $update['fas'][0]['fasbezeichnung']; ?>" list="fas" name="fasbezeichnung" id="fasname" required>
    ...
    <div class="col-xs-7">
        <div class="fastypeselect">
            <select class="form-control" id="fastype" name="fast_id">
                ...
                <?php foreach($fastypes as $value): ?>
                <?php if($value['fast_id']!= $update['fas'][0]['fast_id']): ?>
    ...
    <div class="col-xs-7">
        <div class="fasherstellerselect">
            <select class="form-control" id="fashersteller" name="fash_id">
                <?php foreach($fasherstellers as $value): ?>
                	<?php if($value['fash_id'] != $update['fas'][0]['fash_id']): ?>
                		<option value="<?php echo $value['fash_id']; ?>"><?php echo $value['herstellername']; ?></option >
                	<?php else: ?>
                		<option value="<?php echo $value['fash_id']; ?>" selected><?php echo $value['herstellername']; ?></option >
                	<?php endif; ?>
                <?php endforeach; ?>
            </select>
            <br> <br>
    ...
    <div class="col-xs-7">
        <div class="fasentwicklungselect">
            <select class="form-control" id="fasentwicklng" name="fase_id">
                ...
                <?php if($value['fase_id']!= $update['fas'][0]['fase_id']): ?>
        ...
        <div class="fasserieselect">
            <select class="form-control" id="fasserie" name="fass_id">
                <?php foreach($serie as $value): ?>
                	<?php if($value['fass_id'] != $update['fas'][0]['fass_id']): ?>
                	<option value="<?php echo $value['fass_id']; ?>"><?php echo $value['serie']; ?></option >
                		<?php else: ?>
                		<option value="<?php echo $value['fass_id']; ?>" selected><?php echo $value['serie']; ?></option >
                		<?php endif; ?>
                <?php endforeach; ?>
            </select>
            <br> <br>
...
<div class="row text">
    <div class="col-xs-2">
        <label for="serieseit"><span class="tt">Serie seit</span></label>
    </div>
    <div class="col-xs-7">
        <input type="text" class="form-control " value="<?php echo $update['fas'][0]['serie_seit']; ?>" name="serie_seit" id="serieseit" required>
...
<div class="row text">
    <div class="col-xs-2">
        <label for="seriebis"><span class="tt">Serie bis</span></label>
    </div>
    <div class="col-xs-7">
        <input type="text" class="form-control " value="<?php echo $update['fas'][0]['serie_bis']; ?>" name="serie_bis" id="seriebis" required>
...
<div class="row text">
    ...
    <div class="col-xs-7">
        <!--<input type="text" class="form-control " placeholder="Serie bis z.B 2016" name="">-->
        	<textarea name="funktion" style="resize:none;width:450px;height:120px;"  id="functionsbeschreibung"><?php echo $update['fas'][0]['funktion']; ?></textarea>
    ...
    <div class="col-xs-7">
        <div class="faswaehrungselect">
            <select class="form-control" id="faswaehrung" name="w_id">
                ...
                <?php if($value['w_id']!= $update['fas'][0]['w_id']): ?>
...
<div class="row text">
    ...
    <div class="col-xs-4">
        <input type="text" class="form-control " value="<?php echo $update['betriebsgrenze'][0]['von']; ?>" name="von" id="ub" required>
    ...
    <div class="col-xs-2">
    	...
    	<div>
            <select class="form-control" id="einheit1" name="einheit_id[]" style="width: 120px;">
                ...
                <?php if($value['einheit_id'] != $update['betriebsgrenze'][0]['einheit_id']): ?>
                		<option value="<?php echo $value['einheit_id']; ?>"><?php echo $value['einheit']; ?></option >
                	<?php else: ?>
                		<option value="<?php echo $value['einheit_id']; ?>" selected><?php echo $value['einheit']; ?></option >
                	<?php endif;?>
                <?php endforeach; ?>
            </select>
            <br> <br>
...
<div class="row text">
    ...
    <div class="col-xs-4">
        <input type="text" class="form-control " value="<?php echo $update['betriebsgrenze'][0]['bis']; ?>" name="bis" id="ob" required>
...
var count = <?php echo  count($update['quelle']); ?>;
$(function() {
...
<?php foreach($update['film'] as $key => $value): ?>
	
		<div class='out'>
				<div class='col-xs-2'>
						<input type='hidden' name='film_id[]' value="<?php echo $value['film_id']; ?>">link[<?php echo $key+1;?>]
				</div>
				<div class='col-xs-7'><?php echo $value['link'] ?></div>
				<div class='col-xs-3'>
					<a href='javascript:' onclick='del(this,film)'>
						<button type='button' class='btn btn-default'>
							<span class='glyphicon glyphicon-remove' aria-hidden='true'></span>
						</button>
					</a>
...
<script>
var film = <?php echo count($update['film']); ?>;
$(function() {
...
<div class="quelle row autos">
    <div class="col-xs-2">
        <label for="autotitle"><span>Auto</span></label>
    </div>
    <div class="col-xs-7">
        <div class="autoselect">
            <select class="form-control" id="autotitle"">
...
<?php foreach($update['auto'] as $key => $value): ?>
...
<script>
var auto = <?php echo count($update['auto']); ?>;
$(function() {
...
//         alert(index);
        $.ajax({
        	...
        	success:function(data) {
//      		alert(data.message);
        		var str = "<div class='out'><div class='col-xs-2'><input type='hidden' name='fahrzeugen_id[]' value='"+index+"'>auto["+auto+"]</div><div class='col-xs-7'>"+data.fahrzeugname+"</div><div class='col-xs-3'><a name='cb[]'  onclick='del(this,auto)' ><button type='button' class='btn btn-default'><span class='glyphicon glyphicon-remove' aria-hidden='true'></span></button></a></div></div>";
//      		alert(str);
...
<?php foreach($update['sensor'] as $key => $value): ?>
	
		<div class='out'>
				<div class='col-xs-2'>
						<input type='hidden' name='sensor_id[]' value="<?php echo $value['s_id']; ?>">sensor[<?php echo $key+1;?>]
				</div>
				<div class='col-xs-7'><?php echo $value['sensorname'] ?></div>
				<div class='col-xs-3'>
					<a href='javascript:' onclick='del(this,sensor)'>
						<button type='button' class='btn btn-default'>
							<span class='glyphicon glyphicon-remove' aria-hidden='true'></span>
						</button>
					</a>
...
<script>
var sensor = <?php echo count($update['sensor']); ?>;
$(function() {
